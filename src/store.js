...
const productSlice = createSlice({
    ...
    initialState: {
        ...
        nonveg: [
            ...
            { name: 'Fish', price: 280.8, image: '/images/non-veg/fish1.avif', description: 'Fresh fish rich in omega-3, great for grilling, frying, or curries.' },
            { name: 'Mutton', price: 520.0, image: '/images/non-veg/mutton1.jpg', description: 'Premium quality mutton for rich, flavorful curries or roasts.' },
        ...
        milk: [
            { name: 'Milk (1L)', price: 55.0, image: '/images/milk/milk2.jpg', description: 'Fresh, full-fat milk, perfect for your daily dairy needs.' },
        ...
        chocolate: [
            ...
            { name: 'KitKat (2 Finger)', price: 15.0, image: '/images/chocolate/kitkat1.jpg', description: 'Crispy wafer fingers covered with rich milk chocolate.' },
            { name: 'Perk', price: 10.0, image: '/images/chocolate/perk2.jpg', description: 'Light wafer bar with a sweet chocolate coating.' },
            { name: '5 Star', price: 25.0, image: '/images/chocolate/fivestar1.jpg', description: 'Chewy caramel and nougat bar covered in chocolate.' },
