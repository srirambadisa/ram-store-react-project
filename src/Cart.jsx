        ...
        <div className="cart-container">
            ...
            {cartObjects.length === 0 ? (
                ...
                <>
                    ...
                    <strong><p style={{color:'white'}}>Total Bill: ${totalPrice.toFixed(2)}</p></strong>
                    ...
                    <p style={{color:'white'}}>After Discount: ${priceAfterDiscount.toFixed(2)}</p>
                    ...
                    <p style={{color:'white'}}>Coupon Discount: ${afterDiscount.toFixed(2)}</p>
                    ...
                    {paymentMethod === 'upi' && (
                        <div className="scanner-wrapper">
                            <div className="upi-section">
                                ...
                                <QRCode value={`upi://pay?pa=srirambadisa1938-2@oksbi&pn=MyStore&am=${finalPrice.toFixed(2)}&cu=INR`} />
                                <p>UPI ID: srirambadisa1938-2@oksbi</p>
                            </div>
                        </div>
                    )}
